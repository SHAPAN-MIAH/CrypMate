        ...
        <div>
          ...
          >
            <div id="createModal">
              ...
              <div className="mb-4">
                <h5 className="text-center mt-2 mb-3">How does CrypMate wallet work</h5>
                ...
                <div>
                  <div className="howMetaMask-walletWork-videoContainer-list">
                    ...
                    <div>
                    <p>CrypMate is a decentralized wallet that stores different assets on the Ethereum blockchain. This includes coins, tokens, and NFTs</p>
                    </div>
                  </div>
                  <div className="howMetaMask-walletWork-videoContainer-list">
                    ...
                    <div>
                    <p>With CrypMate, you can access other decentralized applications on the Web3.0 through your browser.</p>
                    </div>
                  </div>
                  <div className="howMetaMask-walletWork-videoContainer-list">
                    ...
                    <div>
                    <p> CrypMate generates passwords and keys on your device, so only you have access to your accounts and data. You always choose what to share and what to keep private.</p>
                    </div>
                  </div>
                </div>
              </div>
