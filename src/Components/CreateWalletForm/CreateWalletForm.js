...
const CreateWalletForm = () => {
  ...
  return (
    <div className="container" style={{margin: '0px 40px'}}>
      <div class="row">
          ...
          <div className="form-container">
            ...
            <form className="forms" onSubmit={handelSubmit}>
              <div class="form-group formGroup">
                ...
                <input onChange={handleChange} type="password" name="password" id="password" minLength="8" class="form-control shadow-none" placeholder="" aria-describedby="helpId" required/>
                <div id="passwordNotEnough"></div>
              </div>
              <div class="form-group formGroup">
                <label for="">Confirm password</label>
                <input onChange={handleChange} type="password" name="password" id="confirmPassword" class="form-control shadow-none" placeholder="" aria-describedby="helpId" required/>
        ...
        <div className="col-md-7">
          <div className="help-container">
            <div className='helpvideo-container'>
              <video controls style={{ borderRadius: '5px', width: 'auto', height: '250px', boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px' }}>
                <source
                  type="video/webm"
                  src={video4}
                />
