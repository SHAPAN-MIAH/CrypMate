        ...
        <div className="buy-modal-container">
          <div className="buy-modal-header d-flex">
            <div className="buy-header-title">
              <h4>Deposit Ether</h4>
              <p>To interact with decentralized applications using CrypMate, you'll need Ether in your wallet.</p>
            </div>
          ...
          <div className="buy-modal-content">
            <div class="row">
              <div className="col-md-6">
                ...
                <video controls style={{ borderRadius: '5px', width: '270px', height: 'auto', boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px'}}>
                  <source
                    type="video/webm"
                    src={video6}
                  />
              ...
              <div className="col-md-6" style={{borderLeft: "1px solid gainsboro"}}>
                <div className="buy-eth-with-wyre d-flex">
                  <div className="wyre-img d-flex align-items-center">
                    ...
                    <div className="wyre-text">
                      ...
                      <small>Wyre lets you use a debit card to deposit ETH right in your CrypMate account.</small>
                      <br/>
