...
const Send = () => {
  ...
  const transactionHistorySave = (e) => {
    ...
    setETHBalance(ETHRemaining)
    setUSDBalance(USDRemaining)
    ...
    // axios.post('https://protected-gorge-73198.herokuapp.com/addTransactionHistory', transactionHistory)
    // .then(res => {
    //   console.log("done");
    // })
  }
  ...
  const dispatchingData = {
    ...
    MaxPriorityFee: '-37 GWEI',
    MaxFee: '0.000045 GWEI',
    Eth: ETHBalance - selectedEth,
    Usd: USDBalance - selectedEth,
    _id: new Date()
        ...
        <div className="send-modal-container">
            ...
            <div className="send-header-input">
              ...
              <div>
                ...
                <form onSubmit={SearchUserHandler}>
                  ...
                  <input type="text" name="Search" id="Search" onChange={handleChange} placeholder="Search, public address (0x), or ENS" required/>
          ...
          <div className="faucet-footer">
            <div class="row">
              ...
              <div className="col-md-4">
              <a href=""><h6>Ethereum Name Service (ENS)</h6></a>
                <small>ENS is a way to shorten an address into a name to avoid any mistaken transactions, like how a website's domain name(Ex: youtube.com) is used instead of its IP address.</small>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="faucet-id-container mb-3">
              ...
              <div className="faucet-id-box">
                <div className="faucet-id-content d-flex">
                  <p className="f-name">Faucet <br/> <span className="f-id">{selectUsersName}</span></p>
          ...
          <div class="row">
            <div className="col-md-6">
              ...
              <div className="gas-text">
                ...
                <p>You can think of your gas limit like a budget you set for the miner processing your transactions. Gas markets determine if and when transactions will get confirmed. 
                  <br/><br/> 
                  Set your gas price too low and your transaction may get stuck. Set your gas limit too low and your transaction cannot be executed because it runs out of gas.</p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              ...
              <div className="faucet-send-assets-amount-transaction">
                ...
                <div className="estimated-fee d-flex">
                  <p>Estimated Gas Fee <span><FontAwesomeIcon icon={faQuestionCircle} /></span></p>
                ...
                <div className="total-amount-container">
                  <div className="total-container d-flex">
                    <h6>TOTAL</h6>
                    <span className="lowTotalEth">{lowTotal}  <span className='lowTotalTitle'>Eth</span></span>
                    <span className="AllTotalEth">{total} <span className='allTotalTitle'>Eth</span></span>
                  </div>

                  <div className="amount-container d-flex">
                    <h6>Amount + Gas Fee</h6>
                    {/* <span>{maxTotal} ETH</span> */}
                    <span className="lowMaxTotalEth">{lowTotal} <span className='lowMaxTotalTitle'>Eth</span></span>
                    <span className="AllMaxTotalEth">{total} <span className='allMaxTotalTitle'>Eth</span></span>
