    ...
    <div>
      <div className="import-wallet-container">
          ...
          >
            <div className="importModal">
              ...
              <div className="mt-5 mb-5">
                <h5 className="text-center mt-5 mb-5">How does importing a CrypMate wallet works</h5>
                <ol>
                  ...
                  <li>Create a new password for the CrypMate extension on your computer that is secure.</li>
                  <li>That's it! You're setup on CrypMate and now have access to the account your imported.</li>
                </ol>
              </div>
            </div>
          </Modal>
        ...
        <div className="mt-4">
          ...
          <h6>No, I already have a Secret Recovery Phrase</h6>
