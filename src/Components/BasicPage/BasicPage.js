        ...
        <div className="basic-section">
          <div className="basic-container">
            ...
            <div className="content-text">
              <p>Before getting started, it's important that you have a good understanding on how <br/> cryptocurrencies and blockchain technology works.</p>
              <small>Here are some videos we suggest on the basics.</small>
            </div>
            <div className="content-video mt-4">
              <div class="row">
                <div className="col-md-4">
                  <div className="video-container">
                    <video controls style={{ borderRadius: '5px', width: '335px', boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px'}}>
                      <source
                        type="video/webm"
                        src={video1}
                      />
            ...
            <div className="lets-moveText mt-4">
              <p>Now that you have a basic understanding of everyThing. Let's move on to the wallet setup.</p>
            </div>
            <div>
