  ...
  return (
    <>
      <div className="container-fluid" style={{width: "1200px", margin: "auto"}}>
        ...
        <div style={{margin: '0 50px'}} className="matricsChart-img">
          <img src={metricsChart} alt=""/>
        </div>
        <div className="helpUsImproveWallet-container">
          <div className="HelpUsImproveWallet-title">
            <h1>Help us improve CrypMate</h1>
          </div>
          <div className="improve-help-text">
            <p>CrypMate would like to gather usage data to better understand how our users interact with the extension. This data will be used to continually improve the usability and user experience of our product and the Ethereum ecosystem.</p>
            <p>CrypMate will..</p>
          ...
          <button onClick={() => goTo(CreateWallet)} id="noThanksBtn" type="">No Thanks</button>
          <button onClick={() => goTo(CreateWallet)} id="agreeBtn" type="">I Agree</button>

          <div className="policy-container">
            <p>This data is aggregated and is therefore anonymous for the purposes of General Data Protection Regulation (EU) 2016/679. For more information in relation to our privacy practices,<br/>please see our <a className="policy-link" href="">Privacy Policy here</a>.</p>
          </div>
        </div>
      </div>
    </>
...
export default CreateHelpImproveWallet;