          ...
          <div class="row">
            ...
            <div className="col-md-7">
              <div className="secret-backup-phrase-container">
                ...
                <div className="secret-warning">
                  <p><span>WARNING:</span> Never disclose your backup phrase. Anyone with this phrase can take your assets forever.</p>
                </div>

                <div onClick={handleShowPhrase} className='sBPhraseContainer mb-3'>
                  <div className="secret-backup-phrase d-flex align-items-center">
                    <span>strong royal fantasy brother quick plastic accuse neglect boat carbon estate wave</span>
                  </div>

                  <div className="lock-icon-word">
                    <span className="lock-icon"><FontAwesomeIcon icon={faLock} /></span> <br/>
                    <small>CLICK HERE TO REVEAL SECRET WORDS</small>
                  </div>
                </div>

                <button onClick={() => goTo(ConfirmSecretBackupPhrase)} id="nextBtn" type="">Next</button>
            ...
            <div className="col-md-5">
              ...
              <div className="download-encrypted-container mt-4">
                ...
                <button id="downloadPhrase" onClick={() => goTo(SeedPhraseEncryptInfo)}>Download and encrypt your backup phrase</button>
              </div>
            </div>
          </div>
      </div>
