...
const PhishingWarningPage = () => {
  return (
    <>
      <div className='container-fluid  text-center' style={{width: "900px", margin: "auto"}}>
        ...
        <div className='phishingWarning-text'>
          <p>
            There has been a recent spike in phishing attacks due to users <br/>downloading unofficial CrypMate software from ads.
          </p>
          <h5>
            Only download CrypMate from the official CrypMate <br/>website (CrypMate.oi) on these verified browsers.
          </h5>
        </div>
